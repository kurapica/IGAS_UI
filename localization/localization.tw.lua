...
<p>
    1. 動作條系統添加了最大和最小不透明度選項。可用來調整透明度。
</p>
<br/><br/>
<p>
...
<p>
    1. 團隊面板新增宏綁定工具，用戶可以直接綁定按鍵到指定的宏(文本)。
</p>
<p>
    2. 用戶可以為部分增益指定順序，這些特殊增益將被按順序優先顯示。
</p>
<br/><br/>
<p>
...
<p>
    1. 團隊面板加入了“按下即觸發”菜單項，勾選時，動作按下時就會觸發施法。
</p>
<br/><br/>
<p>
...
<p>
    1. 右鍵點擊小地圖的區域名字來切換小地圖的自動漸隱效果。
</p>
<p>
    2. 右鍵點擊任務列表的頭部來切換任務列表的自動漸隱效果。
</p>
<br/><br/>
<p>
...
<p>
    1. 如果隱藏了原始界面的話，微型菜單可以被移動，也可以設置自動隱藏或者漸隱。
</p>
<p>
    2. 額外動作條可以被移動。
</p>
...
<p>
    1. 自動隱藏和自動漸隱系統可以合用，同時使用時，符合自動隱藏的條件時，啟用自動漸隱效果，不再使用自動隱藏。
</p>
<p>
    2. 宏條件編輯器添加了部分目標，用於判別boss戰，競技場等等。
</p>
<br/><br/>
<p>
...
<p>
    1. 自動填充彈出動作條的過濾代碼和順序設置被移除，提示信息過濾設置被加入，可以用于過濾比如'神器能量'之類的物品。
</p>
<p>
    2. 所有的物品類自動填充彈出動作條將使用壹個線程進行更新，降低消耗，並且同壹個物品將只會被生成壹次。
</p>
<br/><br/>
<p>
...
<p>
    2. 增益/減益/職業增益的屬性(例如位置，行列等)都可以在菜單中進行配置。
</p>
<br/><br/>
<p>
...
<p>
    1. 現在玩家的所有增益效果都會顯示在團隊面板，通過右鍵點擊可以送入黑名單，不再顯示，操作和移除減益相同。
</p>
<br/><br/>
<p>
...
<p>
    1. 進入遊戲後，背包視圖將自動按照順序延時加載，這樣避免第壹次打開背包視圖時的卡頓問題。新的刷新機制加入，避免卡頓。
</p>
<p>
    2. 爲了避免進入遊戲時就處于戰鬥狀態，現在加入了壹個默認的整合背包視圖，無法修改和刪除，這個視圖會在遊戲進入時加載，確保物品使用沒有問題。
</p>
<br/><br/>
<p>
...
<p>
    1. '未收藏外觀'規則被加入背包視圖系統，僅用於顯示具有未收藏外觀的裝備，以便加入你的收藏。
</p>
<br/><br/>
<p>
...
L["Right mouse-click send buff/debuff to black list"] = "右鍵點擊增益/減益送至黑名單"
...
L["Macro Bindings"] = "宏綁定編輯器"
L["Use '%unit' in macro as spell target"] = "在宏中使用%unit來替代動作目標"
L["You can drag spell into the edit box"] = "妳可以拖拽技能放入輸入框"

L["Buff Order List"] = "增益顯示順序"
L["Please input the buff's spell id(you can get it in the game tip)"] = "請輸入增益的技能ID(妳可以在鼠標提示中找到)"
...
L["Save action bar's settings"] = "保存該動作條布局及內容"
L["Apply action bar's settings"] = "載入動作條布局及內容"