...
<p>
    1. 妳可以為彈出按鈕指定按鍵，這些按鈕僅當自身顯示時綁定這些按鍵，當自身隱藏時會釋放它們，所以，可以綁定例如1，2，3之類常用按鈕給它們。
</p>
<p>
    2. 如果壹個根按鈕沒有內容，那麽點擊或者使用按鍵定義它，會顯示它的彈出按鈕，以便選擇使用。
</p>
<br/><br/>
<p>
...
<p>
    1. 動作條現在開始支持Masque皮膚插件。
</p>
<p>
    2. 如果壹個動作條只含有壹個按鈕(該按鈕有彈出動作條)，那麽可以使用"方形布局"或者"圓形布局"來快速進行布局。
</p>
<p>
    3. 新的動作條映射: 世界標記，團隊標記。
</p>
