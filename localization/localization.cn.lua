...
<p>
    1. 团队面板加入了“按下鼠标触发”菜单项，勾选时，动作按下时就会触发施法。
</p>
<br/><br/>
<p>
...
<p>
    1. 鼠标移到聊天栏的链接上，会显示对应的信息，也可以比较成就和物品。
</p>
<p>
    2. 背包系统增加自动修理，贩卖，分割，堆叠功能。
</p>
<p>
    3. 自动任务加入(默认关闭)。
</p>
<p>
    4. 修复弹出技能的自动生成机能。偶尔会在恰当的时候显示出来。
</p>
<br/><br/>
<p>
...
<p>
    1. 右键点击小地图的区域名字来切换小地图的自动渐隐效果。
</p>
<p>
    2. 右键点击任务列表的头部来切换任务列表的自动渐隐效果。
</p>
<br/><br/>
<p>
...
<p>
    1. 自动隐藏和自动渐隐系统可以合用，同时使用时，符合自动隐藏的条件时，启用自动渐隐效果，不再使用自动隐藏。
</p>
<p>
    2. 宏条件编辑器添加了部分目标，用于判别boss战，竞技场等等。
</p>
<br/><br/>
<p>
...
<p>
    1. 团队面板中，不再使用右键来将增益/减益送入黑名单，而是使用Alt+右键，避免误操作。
</p>
<p>
    2. 自动生成玩具时会忽略正在冷却的玩具，已保证玩具条上的玩具一直是玩家可用的。
</p>
<br/><br/>
<p>
...
<p>
    1. 存入银行仓库的按钮位置被调整，以便于使用。
</p>
<p>
    2. 代币会被显示在背包视图上，可以通过菜单修改监视列表。
</p>
<br/><br/>
<p>
